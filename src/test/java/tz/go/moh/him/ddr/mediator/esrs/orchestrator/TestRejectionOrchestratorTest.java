...
import tz.go.moh.him.ddr.mediator.esrs.mock.MockDestination;
...
public class TestRejectionOrchestratorTest extends BaseTest{
     ...
     */
    protected JSONObject ldrErrorMessageResource;
    ...
    public void before() throws Exception {
        ...
        try {
            if (stream != null) {
                ldrErrorMessageResource = new JSONObject(IOUtils.toString(stream));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void testMediatorHTTPRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = TestRejectionOrchestratorTest.class.getClassLoader().getResourceAsStream("test-rejection.json");

            assertNotNull(stream);


            createActorAndSendRequest(system, testConfig, getRef(), IOUtils.toString(stream), TestRejectionOrchestrator.class, "/send-test-rejections");
    ...
    public void testInValidPayload() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = TestRejectionOrchestratorTest.class.getClassLoader().getResourceAsStream("invalid-test-rejection.json");
    ...
    public void testInvalidDates() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = TestRejectionOrchestratorTest.class.getClassLoader().getResourceAsStream("invalid-date-test-rejection.json");
